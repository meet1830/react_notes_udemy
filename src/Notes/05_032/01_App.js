...
function App() {
  ...
  return (
    <div className="App">
      ...
      {/* take the template of events.map and put it in its own separate component, for this passing props for events and handleclick as both will be needed in the component else undefined */}
